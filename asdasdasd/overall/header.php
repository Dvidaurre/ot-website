  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div class="top-bar">
		<a href="register.php">
							...
							Perfect Tibia will start in: <span style="color: yellow;" id="countdown">loading...</span>
							<?php
							} else {
								echo 'Perfect Tibia e 8.0 Will Start In: <span style="color: yellow;">SERVER STARTED!</span>';
							}
							?>
		</a>
	</div>
					...
					<div class="content_bg">
						<div class="content">
							<div class="rise-up-content" style="min-height: 150px;">
								<div class="fb-page" style="padding: 10px 47px;" data-href="" data-width="500" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="false"><blockquote cite="" class="fb-xfbml-parse-ignore"><a href="">Arkonia Online</a></blockquote></div>
							</div>
						</div>
					</div>
					<div class="border_bottom"></div>
